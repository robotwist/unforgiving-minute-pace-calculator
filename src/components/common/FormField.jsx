...
const FormField = ({
  ...
  return (
    <div className={`space-y-2 ${className}`}>
      {label && (
        <label className="um-label flex um-items-center gap-2" style={{ color: colors.black }}>
          <span>{label}</span>
      ...
      <div className="um-relative">
        ...
        {/* Success indicator */}
        {success && !error && (
          <div className="um-absolute right-3 top-1/2 transform -translate-y-1/2">
      ...
      {error ? (
        <p className="um-text-xs text-red-600 flex um-items-center gap-1" role="alert">
